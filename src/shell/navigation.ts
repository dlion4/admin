...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    pages: [
      { id: "fraud", page: 15, label: "Fraud Dashboard", icon: "bi-shield-exclamation", ready: true, badge: 23, summary: "Fraud loss, alert triage and rule performance.", sections: ["Loss metrics", "Alert queue", "Rule hit rates", "Blacklist"] },
      { id: "sar", page: 16, label: "Transaction Monitoring", icon: "bi-binoculars", ready: true, summary: "Rule-based and ML monitoring producing SARs.", sections: ["Scenario library", "Case queue", "SAR filing", "FRA submission"] },
      { id: "risk-scoring", page: 17, label: "Risk Scoring Engine", icon: "bi-sliders2", ready: true, summary: "Feature weights, model versions and score distribution.", sections: ["Model registry", "Feature weights", "Score bands", "Backtesting"] },
      { id: "aml", page: 18, label: "AML & Sanctions", icon: "bi-globe-americas", ready: true, summary: "Sanctions screening, PEP lists and adverse media.", sections: ["Watchlists", "Screening hits", "PEP review", "Audit trail"] },
      { id: "incident", page: 19, label: "Incident Response", icon: "bi-fire", ready: true, badge: 1, summary: "P1–P4 incident lifecycle with on-call and postmortems.", sections: ["Open incidents", "On-call roster", "Runbooks", "Postmortems"] },
    ],
  },
  {
    id: "products", label: "PRODUCTS & SERVICES", icon: "bi-box-seam",
    pages: [
      { id: "portfolio", page: 20, label: "Service Portfolio", icon: "bi-collection", ready: true, summary: "Catalogue of all 24 live PayMo services and their P&L.", sections: ["Service list", "Adoption", "Revenue per service", "Lifecycle stage"] },
      { id: "product-config", page: 21, label: "Product Configuration", icon: "bi-gear-wide-connected", ready: true, summary: "Per-product parameters, limits and eligibility rules.", sections: ["Parameters", "Eligibility", "Rollout rings", "Versioning"] },
      { id: "recurring", page: 22, label: "Recurring Services", icon: "bi-arrow-clockwise", ready: true, summary: "Standing orders, subscriptions and scheduled disbursements.", sections: ["Mandates", "Retry policy", "Dunning", "Churn"] },
      { id: "cards", page: 23, label: "Card Programs", icon: "bi-credit-card-2-front", ready: true, summary: "Visa & Mastercard BIN ranges, issuance and chargebacks.", sections: ["BIN registry", "Issuance queue", "Chargebacks", "Scheme fees"] },
      { id: "utility", page: 24, label: "Utility Services", icon: "bi-lightning-charge", ready: true, summary: "Airtime, KPLC, water, DStv and government bill aggregators.", sections: ["Biller registry", "Commission grid", "Downtime", "Reconciliation"] },
    ],
  },
  {
    id: "partners", label: "PARTNERS & INVESTORS", icon: "bi-handshake",
    pages: [
      { id: "partner-dir", page: 25, label: "Partner Directory", icon: "bi-buildings", ready: true, summary: "42 active partners with contracts, fees and settlement status.", sections: ["Partner list", "Contracts", "Fee terms", "Settlement status"] },
      { id: "partner-onboard", page: 26, label: "Partner Onboarding", icon: "bi-node-plus", ready: true, badge: 12, summary: "Application → due diligence → sandbox → go-live pipeline.", sections: ["Applications", "Due diligence", "Sandbox keys", "Go-live checklist"] },
      { id: "investor", page: 27, label: "Investor Dashboard", icon: "bi-graph-up-arrow", ready: true, summary: "Cap table, valuation history and investor KPIs.", sections: ["Cap table", "Valuation", "Runway", "Board pack"] },
      { id: "investor-reports", page: 28, label: "Investor Reports", icon: "bi-file-earmark-bar-graph", ready: true, summary: "Quarterly reports, dividend runs and data-room access.", sections: ["Report builder", "Dividends", "Data room", "Access log"] },
    ],
  },
  {
    ...
    pages: [
      ...
      { id: "sysconfig", page: 32, label: "System Configuration", icon: "bi-toggles", ready: true, summary: "Environment config, secrets rotation and maintenance windows.", sections: ["Config keys", "Secrets", "Maintenance", "Backups"] },
      { id: "api", page: 33, label: "API & Integrations", icon: "bi-plug", ready: true, summary: "API keys, webhooks, rate limits and partner sandboxes.", sections: ["Keys", "Webhooks", "Rate limits", "Docs"] },
      { id: "flags", page: 34, label: "Feature Flags", icon: "bi-flag", ready: true, summary: "LaunchDarkly-backed flags with targeting and kill switches.", sections: ["Flag list", "Targeting", "Kill switches", "Rollout"] },
      { id: "api-health", page: 43, label: "API Health & Interconnect", icon: "bi-activity", ready: true, badge: 23, summary: "Circuit breakers, callbacks, DLQ and dependency map.", sections: ["Circuit breakers", "Callback registry", "DLQ", "Latency heatmap", "Impact analysis"] },
    ],
  },
  {
    id: "comms", label: "COMMUNICATIONS", icon: "bi-megaphone",
    pages: [
      { id: "notifications", page: 35, label: "Notification Center", icon: "bi-bell", ready: true, badge: 9, summary: "Template registry and delivery analytics for push/SMS/email.", sections: ["Templates", "Delivery rates", "Channels", "Opt-outs"] },
      { id: "broadcast", page: 36, label: "Broadcast Messages", icon: "bi-send", ready: true, summary: "Segment-targeted broadcasts with approval workflow.", sections: ["Composer", "Segments", "Approval", "Send history"] },
      { id: "support", page: 37, label: "Customer Support Queue", icon: "bi-headset", ready: true, badge: 12, summary: "Ticket queue with SLA timers and agent workload.", sections: ["Queue", "SLA", "Agent load", "Macros"] },
    ],
  },
  {
    id: "docs", label: "DOCUMENTS & LEGAL", icon: "bi-file-earmark-text",
    pages: [
      { id: "terms", page: 38, label: "Terms & Conditions", icon: "bi-file-text", ready: true, summary: "Versioned T&C with legal review and user re-consent.", sections: ["Versions", "Diff", "Legal review", "Re-consent"] },
      { id: "privacy", page: 39, label: "Privacy Policy", icon: "bi-incognito", ready: true, summary: "ODPC-aligned privacy policy and DSAR handling.", sections: ["Policy versions", "DSAR queue", "Retention", "Consent"] },
      { id: "compliance-docs", page: 40, label: "Compliance Documents", icon: "bi-folder-check", ready: true, summary: "CBK licences, audits and regulator correspondence.", sections: ["Licences", "Audit reports", "Correspondence", "Expiry alerts"] },
      { id: "templates", page: 41, label: "Document Templates", icon: "bi-files", ready: true, summary: "Statement, receipt and notice templates with merge fields.", sections: ["Template list", "Merge fields", "Preview", "Publish"] },
    ],
  },
  {
