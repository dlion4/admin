...
export const ACTIVITY: Activity[] = [
  { id: "AUD-88231", time: "2 min ago", admin: "Joseph Mwangi", role: "Super Admin", action: "Froze account", target: "User #89234", details: "Fraud suspicion — dual browser session from two counties", ip: "197.232.14.88", tone: "red", category: "Users", reversible: true },
  ...
  { id: "AUD-88228", time: "22 min ago", admin: "Joseph Mwangi", role: "Super Admin", action: "Granted VIP status", target: "User #4512", details: "Exempt from transaction fees for 12 months", ip: "197.232.14.88", tone: "green", category: "Users", reversible: true },
  ...
  { id: "AUD-88222", time: "2 hours ago", admin: "Joseph Mwangi", role: "Super Admin", action: "Rotated API credential", target: "Safaricom Daraja", details: "Consumer secret rotated; old key valid for 60 more minutes", ip: "197.232.14.88", tone: "blue", category: "System", reversible: false },
  ...
  { id: "AUD-88216", time: "7 hours ago", admin: "Joseph Mwangi", role: "Super Admin", action: "Created admin", target: "Cynthia Awuor — Support Agent", details: "Tier 8, reports to Support Lead, passkey pending", ip: "197.232.14.88", tone: "blue", category: "Admins", reversible: true },
