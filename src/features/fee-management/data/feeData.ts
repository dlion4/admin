...
export const FEE_SCHEDULES: FeeSchedule[] = [
  ...
  { id: "FEE-003", name: "M-Pesa cash-out (withdrawal)", category: "Cash & Agents", icon: "bi-cash-stack", method: "Tiered", rate: 2.0, fixed: 0, minFee: 20, maxFee: 0, taxTreatment: "VAT 16% + Excise 20%", appliesTo: "All users · tiered by volume", channels: "M-Pesa (Daraja)", revenue30d: 38_700_000, txns30d: 198_432, effectiveRate: 1.93, volume30d: 2_005_000_000, status: "Active", lastChanged: "14 Jan 2026", changedBy: "Jeckonia Kwasa", competitor: 2.0, overrides: 96, nextChange: "CHG-1187" },
  ...
  { id: "FEE-008", name: "International transfer (SWIFT)", category: "FX & Global", icon: "bi-globe-americas", method: "Hybrid", rate: 3.5, fixed: 500, minFee: 500, maxFee: 0, taxTreatment: "VAT 16% incl.", appliesTo: "KYC Tier 2+", channels: "SWIFT, Wise", revenue30d: 2_100_000, txns30d: 4_230, effectiveRate: 3.38, volume30d: 62_100_000, status: "Active", lastChanged: "05 Jan 2026", changedBy: "Jeckonia Kwasa", competitor: 4.0, overrides: 12, nextChange: "CHG-1185" },
  ...
  { id: "FEE-018", name: "Partner API calls (per 1,000)", category: "Platform", icon: "bi-plug", method: "Flat", rate: 0, fixed: 5, minFee: 5, maxFee: 5, taxTreatment: "VAT 16% incl.", appliesTo: "42 partner integrations", channels: "PayMo API", revenue30d: 1_400_000, txns30d: 280_000_000, effectiveRate: 100, volume30d: 1_400_000, status: "Active", lastChanged: "08 Jul 2026", changedBy: "Jeckonia Kwasa", competitor: 8, overrides: 4 },
  { id: "FEE-019", name: "Dormancy fee (12m inactive)", category: "Platform", icon: "bi-moon-stars", method: "Flat", rate: 0, fixed: 0, minFee: 0, maxFee: 0, taxTreatment: "VAT exempt", appliesTo: "Dormant accounts — waived", channels: "System", revenue30d: 0, txns30d: 8_450, effectiveRate: 0, volume30d: 0, status: "Inactive", lastChanged: "04 Feb 2026", changedBy: "Jeckonia Kwasa", competitor: 300, overrides: 0 },
...
export const FEE_OVERRIDES: FeeOverride[] = [
  ...
  { id: "OVR-3105", userId: "PAY-VIP-011", userName: "Zawadi Enterprises", segment: "VIP · Business", feeId: "FEE-014", feeName: "PesaLink send", standard: "0.8% (min 25)", override: "0.4% (min 25)", discountPct: 50, reason: "High-volume payroll corridor", grantedBy: "Sarah Kamau", approvedBy: "Jeckonia Kwasa", grantedAt: "18 Aug 2026", expires: "31 Dec 2026", status: "Active", monthlyValue: 64_800 },
  { id: "OVR-3106", userId: "PAY-VIP-002", userName: "Samuel Ndegwa", segment: "VIP · Silver", feeId: "FEE-003", feeName: "M-Pesa cash-out", standard: "2.0% (min 20)", override: "1.5% (min 20)", discountPct: 25, reason: "Silver VIP benefit", grantedBy: "Jeckonia Kwasa", approvedBy: "— (Tier 0)", grantedAt: "12 Aug 2026", expires: "12 Feb 2027", status: "Active", monthlyValue: 8_200 },
  { id: "OVR-3107", userId: "PAY-VIP-007", userName: "Amina Hassan", segment: "VIP · Gold", feeId: "FEE-008", feeName: "International transfer", standard: "3.5% + KES 500", override: "2.5% + KES 250", discountPct: 40, reason: "Gold VIP remittance pricing", grantedBy: "Jeckonia Kwasa", approvedBy: "— (Tier 0)", grantedAt: "10 Aug 2026", expires: "10 Feb 2027", status: "Active", monthlyValue: 21_600 },
  ...
  { id: "OVR-3109", userId: "PAY-VIP-009", userName: "Tulia Events KE", segment: "VIP · Business", feeId: "FEE-004", feeName: "Card payment", standard: "2.5% (min 15)", override: "1.9% (min 15)", discountPct: 24, reason: "Events season volume deal", grantedBy: "Sarah Kamau", approvedBy: "Jeckonia Kwasa", grantedAt: "05 Aug 2026", expires: "05 Oct 2026", status: "Active", monthlyValue: 38_900 },
  ...
  { id: "OVR-3112", userId: "PAY-VIP-013", userName: "Baraka Logistics", segment: "VIP · Business", feeId: "FEE-016", feeName: "Cheque deposit", standard: "1.0% (min 200)", override: "0.5% (min 100)", discountPct: 50, reason: "Fleet payments contract", grantedBy: "Sarah Kamau", approvedBy: "Jeckonia Kwasa", grantedAt: "24 Jul 2026", expires: "24 Jan 2027", status: "Active", monthlyValue: 12_700 },
  { id: "OVR-3113", userId: "PAY-44556", userName: "Sharon Adhiambo", segment: "Goodwill", feeId: "FEE-004", feeName: "Card payment", standard: "2.5% (min 15)", override: "0% (one-off)", discountPct: 100, reason: "Duplicate charge dispute upheld", grantedBy: "Mary Wanjiku", approvedBy: "Jeckonia Kwasa", grantedAt: "19 Jul 2026", expires: "One-off", status: "Expired", monthlyValue: 48 },
  ...
  { id: "OVR-3115", userId: "PAY-90112", userName: "Irene Jepkorir", segment: "Fraud victim", feeId: "ALL", feeName: "All fees — 90 days", standard: "Standard rates", override: "0% (waived)", discountPct: 100, reason: "ATO victim remediation", grantedBy: "Mary Wanjiku", approvedBy: "Jeckonia Kwasa", grantedAt: "02 Jul 2026", expires: "02 Oct 2026", status: "Active", monthlyValue: 2_850 },
  { id: "OVR-3116", userId: "PAY-22334", userName: "Vincent Kariuki", segment: "Beta tester", feeId: "FEE-020", feeName: "Utility bundle promo", standard: "0.75% + KES 5", override: "0% (pilot free)", discountPct: 100, reason: "Bundle pilot ring — free tier", grantedBy: "Sarah Kamau", approvedBy: "Jeckonia Kwasa", grantedAt: "26 Jun 2026", expires: "26 Sep 2026", status: "Active", monthlyValue: 640 },
...
export const SCHEDULED_CHANGES: ScheduledChange[] = [
  ...
  { id: "CHG-1187", feeId: "FEE-003", feeName: "M-Pesa cash-out", current: "2.0% (min 20)", proposed: "Band 2 → 1.60% (min 20)", effective: "15 Sep 2026", submittedBy: "Jeckonia Kwasa", submittedAt: "18 Aug 11:05", status: "Pending approval", impact: "−KES 1.9M/mo · 18,900 band-2 users", approvals: { role: "Super Admin (Tier 0)" } },
  { id: "CHG-1188", feeId: "FEE-001", feeName: "Internal transfer", current: "Band 4: 0.75%", proposed: "Band 4: 0.65% (min 10)", effective: "01 Oct 2026", submittedBy: "Sarah Kamau", submittedAt: "17 Aug 14:22", status: "Approved", impact: "−KES 480K/mo · 1,320 band-4 users", approvals: { role: "Super Admin (Tier 0)", by: "Jeckonia Kwasa", at: "18 Aug 10:00" } },
  ...
  { id: "CHG-1190", feeId: "FEE-019", feeName: "Dormancy fee", current: "Waived (KES 0)", proposed: "KES 100 / month after 18m", effective: "01 Nov 2026", submittedBy: "James Odhiambo", submittedAt: "12 Aug 17:55", status: "Rejected", impact: "Rejected — ODPC retention risk", approvals: { role: "Super Admin (Tier 0)", by: "Jeckonia Kwasa", at: "13 Aug 09:20" } },
  { id: "CHG-1191", feeId: "FEE-005", feeName: "ATM withdrawal", current: "KES 35 flat", proposed: "KES 30 flat", effective: "01 Sep 2026", submittedBy: "Jeckonia Kwasa", submittedAt: "11 Aug 13:47", status: "Scheduled", impact: "−KES 1.2M/mo · 247,890 withdrawals", approvals: { role: "Super Admin (Tier 0)", by: "Jeckonia Kwasa", at: "11 Aug 15:02" } },
];
...
export const EXEMPTION_REQUESTS: ExemptionRequest[] = [
  ...
  { id: "EXR-201", userId: "PAY-VIP-003", userName: "Njeri Holdings", segment: "VIP · Platinum", feeName: "All fees", ask: "Extend full waiver 2027", justification: "Platinum renewal — KES 96M volume", rm: "Jeckonia Kwasa", submittedAt: "21 Aug 09:00", sla: "2 days left", monthlyValue: 96_000, risk: "Low" },
];
...
export const FEE_AUDIT: FeeAudit[] = [
  { id: "AUD-91204", time: "2 min ago", admin: "Jeckonia Kwasa", action: "Submitted fee change", target: "CHG-1187 · M-Pesa cash-out", detail: "Band 2 → 1.60% effective 15 Sep — awaiting Tier 0 approval.", ip: "197.232.14.40" },
  ...
  { id: "AUD-91202", time: "1h ago", admin: "Jeckonia Kwasa", action: "Approved scheduled change", target: "CHG-1188 · Internal transfer", detail: "Band 4 0.75% → 0.65% approved with 2FA.", ip: "197.232.14.40" },
  ...
  { id: "AUD-91199", time: "5h ago", admin: "Jeckonia Kwasa", action: "Rejected change", target: "CHG-1190 · Dormancy fee", detail: "ODPC retention risk — Dormancy stays waived.", ip: "197.232.14.40" },
  ...
  { id: "AUD-91196", time: "Yesterday", admin: "Jeckonia Kwasa", action: "Scheduled ATM cut", target: "CHG-1191 · ATM withdrawal", detail: "KES 35 → KES 30 effective 01 Sep.", ip: "197.232.14.40" },
