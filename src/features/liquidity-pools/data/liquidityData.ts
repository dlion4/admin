...
export const TRANSFERS: PoolTransfer[] = [
  { id: "TRF-7741", date: "23 Aug", time: "14:32", fromPool: "Main Operating", toPool: "Card Settlement", amount: 15_000_000, reason: "Low card pool — utilisation 82%", initiatedBy: "Sarah Kamau (Finance Mgr)", approvedBy: "Joseph Mwangi", status: "Complete" },
  ...
  { id: "TRF-7739", date: "23 Aug", time: "10:15", fromPool: "Main Operating", toPool: "FX Settlement", amount: 4_000_000, reason: "USD buffer top-up", initiatedBy: "David Kiplagat", approvedBy: "Joseph Mwangi", status: "Complete" },
  ...
  { id: "TRF-7737", date: "22 Aug", time: "17:20", fromPool: "Loan Disbursement", toPool: "Main Operating", amount: 5_000_000, reason: "Surplus reallocation above 25% reserve", initiatedBy: "Sarah Kamau (Finance Mgr)", approvedBy: "Joseph Mwangi", status: "Complete" },
  ...
  { id: "TRF-7732", date: "21 Aug", time: "15:22", fromPool: "Main Operating", toPool: "Card Settlement", amount: 10_000_000, reason: "Visa T+1 pre-funding", initiatedBy: "Sarah Kamau (Finance Mgr)", approvedBy: "Joseph Mwangi", status: "Complete" },
  ...
  { id: "TRF-7729", date: "20 Aug", time: "10:44", fromPool: "Main Operating", toPool: "FX Settlement", amount: 6_000_000, reason: "EUR corridor demand", initiatedBy: "David Kiplagat", approvedBy: "Joseph Mwangi", status: "Complete" },
